...
const Logo = styled('div')({
  ...
  alignItems: 'center',
  margin: '2rem auto',
  boxShadow: '0 0 15px rgba(122, 162, 247, 0.5)',
...
export default function AdAnalyticsDashboard() {
  ...
  return (
    <DarkPaper>
      ...
      >
        <MenuHeader variant="h6">Configurações</MenuHeader>
        <List>
          <StyledListItem button onClick={handleInfoClick}>
            <ListItemIcon><InfoIcon style={{ color: '#7aa2f7' }} /></ListItemIcon>
            <ListItemText primary="Sobre o Ad Analytics" />
          </StyledListItem>
          <StyledListItem button>
            <ListItemIcon><SettingsIcon style={{ color: '#7aa2f7' }} /></ListItemIcon>
